          ...
          <ScrollView className="flex-1 p-6">
            ...
            >
              {[
                ...
                >
                  <Text className="text-purple-800">{category}</Text>
                </TouchableOpacity>
              ))}
            </ScrollView>

            {/* My Communities Section */}
            <Text className="text-purple-800 text-xl font-bold mb-4">
              My Communities
            </Text>
            ...
            <View className="gap-5">
              ...
              <View className="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                <View className="flex-row justify-between items-start mb-2">
                  ...
                  <View className="flex-row items-center">
                    ...
                    <Text className="text-purple-800 ml-1">4.2</Text>
                  </View>
                </View>
                <Text className="text-purple-600 mb-3">10k+ Members</Text>
              ...
              <View className="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                <View className="flex-row justify-between items-start mb-2">
                  ...
                  <View className="flex-row items-center">
                    <Ionicons name="star" size={16} color="#F59E0B" />
                    <Text className="text-purple-800 ml-1">3.7</Text>
                  </View>
                </View>
                <Text className="text-purple-600 mb-3">6k+ Members</Text>
                <TouchableOpacity className="bg-purple-600 py-2 rounded-lg">
                  <Text className="text-white text-center">View Community</Text>
                </TouchableOpacity>
              </View>
              ...
              <View className="bg-white p-4 rounded-lg shadow-sm border border-blue-100">
                ...
                <Text className="text-purple-600 mb-3">24k+ Members</Text>
                <TouchableOpacity className="bg-purple-600 py-2 rounded-lg">
                  <Text className="text-white text-center">View Community</Text>
                </TouchableOpacity>
              </View>
